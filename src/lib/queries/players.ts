...
const PLAYER_FIELDS = 'id, first_name, last_name, dni, birth_date, photo_url, division_id, active, inactivo, parent_name, parent_phone, sobrenombre, fecha_alta, colegio'
