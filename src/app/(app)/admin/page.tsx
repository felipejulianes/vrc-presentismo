    ...
    <div className="p-4 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="bg-white border border-gray-200 rounded-xl divide-y divide-gray-100">
          ...
          <Link href="/tutoras" className="flex items-center justify-between px-4 py-3 hover:bg-gray-50 active:bg-gray-100">
            <div className="flex items-center gap-3">
              <span className="text-xl">🎓</span>
              <div>
                <p className="text-sm font-medium text-gray-900">Panel Tutoras</p>
                <p className="text-xs text-gray-400">Docs, jugadores, colegios y visitas</p>
              </div>
            </div>
            <svg className="w-4 h-4 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <div className="space-y-2">
        ...
        <div className="bg-white border border-gray-200 rounded-xl divide-y divide-gray-100">
          ...
          <Link href="/tutoras/schools" className="flex items-center justify-between px-4 py-3 hover:bg-gray-50 active:bg-gray-100">
            <div className="flex items-center gap-3">
              <span className="text-xl">🏫</span>
              <div>
                <p className="text-sm font-medium text-gray-900">Colegios</p>
                <p className="text-xs text-gray-400">Presencia, visitas y catálogo de colegios</p>
              </div>
            </div>
            <svg className="w-4 h-4 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
